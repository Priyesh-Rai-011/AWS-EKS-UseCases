#!/usr/bin/env bash
# ==============================================================================
# apply-all.sh — Deploy UMS Application Stack to EKS (PUBLIC Nodegroup)
# ==============================================================================
#
# USAGE:
...
#     ~/eks-repo/terraform-on-aws-eks/07_EKS_EBS_CSI/04_ebs_csi_addon/eks-public-nodegroup/k8s-manifests/
#
# PREREQUISITES:
...
echo "============================================================"
echo "  Deploying UMS Application Stack (PUBLIC Nodegroup)"
echo "============================================================"
echo ""
