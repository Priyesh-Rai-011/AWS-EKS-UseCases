...
# ==============================================================================
# EKS ADDONS
# No pod-identity-agent here — IRSA handles pod AWS credentials via OIDC tokens
# ==============================================================================
...
# EBS CSI driver — service account gets its IAM role via IRSA (service_account_role_arn)
